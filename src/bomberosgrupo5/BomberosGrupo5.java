...
//------------------------------------------------------------------------------
        //Prueba del método guardar Cuartel [ok] Cargado!!!!
        //  Siniestro sinies =new Siniestro("TipoSiniestro",'2023-11-04', '10:30:00',100,100,"Detalles del siniestro",'2023-11-04',5,18);
//INSERT INTO siniestro (idCodigo, tipo, fechaSiniestro, horaSiniestro, coordx, coordy, detalles, fechaResol, puntuacion, idBrigada)
//VALUES (1, 'TipoSiniestro', '2023-11-04', '10:30:00', 'coordX', 'coordY', 'Detalles del siniestro', '2023-11-04', 5, 1);
        //SiniestroData sini =new SiniestroData(); 
        //sini.guardarSiniestro(sinies);
//----------------------------------------------------------------------------------------------------------
        int opcion = 0;
                        ...
                        switch (subOpcion) {
                            case 1: // Modificar Cuartel
                                ...
                                if (cuartelAModificar != null) {
                                    ...
                                    int nuevaCoordX = Integer.parseInt(JOptionPane.showInputDialog("Ingrese la nueva coordenada X:"));
                                    int nuevaCoordY = Integer.parseInt(JOptionPane.showInputDialog("Ingrese la nueva coordenada Y:"));
                                    ...
                                    cuartelAModificar.setDireccion(nuevaDireccion);
                                    cuartelAModificar.setCoordX(nuevaCoordX);
                                    cuartelAModificar.setCoordY(nuevaCoordY);
                                    cuartelAModificar.setTelefono(nuevoTelefono);
...
//                    while (subOpcion != 5) {
//                        String subInput = JOptionPane.showInputDialog("Elija qué agregar:\n1. Cuartel\n2. Brigada\n3. Bombero\n4. Salir\n5. Volver al menú anterior");
//>>>>>>> fadb7b6483e3f9ed75b16c1b68a1dcb1d4ac5cbe
//
//                        try {
//                            subOpcion = Integer.parseInt(subInput);
//                        } catch (NumberFormatException e) {
