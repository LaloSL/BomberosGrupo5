...
//----------------------Modificar Especialidad.--------------------------------
    public void modificarEspecialidad(int idBrigM, Connection con) {
    String nuevaEspecialidad = JOptionPane.showInputDialog("Ingrese la nueva especialidad de la brigada:");
