...
public class BrigadasOcupadas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Despliegue para visualizar las brigadas que esta asignadas a un siniestro");
...
//------------------------METODOS----------------------
    ...
    private void llenarComboBrigadasOcupadas() {
        List<String> brigadasOcupadas = briga.brigadasOcupadas();

        if (!brigadasOcupadas.isEmpty()) {
           jComboBox1.removeAllItems();
            for (String nombre : brigadasOcupadas) {
